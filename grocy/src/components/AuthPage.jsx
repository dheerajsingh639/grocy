...
const AuthPage = () => {
  ...
  return (
    <div className="flex justify-center p-15 min-h-screen bg-gray-200 px-4">
      <div className="relative flex flex-col md:flex-row w-full max-w-[850px] h-auto md:h-[500px] bg-white shadow-lg rounded-2xl overflow-hidden transition-all duration-700">
        <div
          ...
          ${
            isSignUp
              ? "bg-orange-600 md:absolute md:top-0 md:left-0 md:w-1/2 md:h-full md:translate-x-0 md:rounded-r-[100px]"
              : "bg-orange-600 md:absolute md:top-0 md:left-0 md:w-1/2 md:h-full md:translate-x-full md:rounded-l-[100px]"
          }`}
        >
          {isSignUp ? (
            <>
